...
class Television(PowerConnection, HDMIConnection, RCAConnection):
...
class DVDPlayer(PowerConnection, HDMIConnection):
...
class GameConsole(PowerConnection, HDMIConnection, EthernetConnection):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(PowerConnection, EthernetConnection):
    def connect_to_tv(self, television):
